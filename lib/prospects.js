...
export function rowToProspect(row) {
  return {
    ...
    contractDetails: row.contract_details && typeof row.contract_details === 'object'
...
export function prospectToRow(p) {
  const row = {
    ...
    contract_details: p.contractDetails && typeof p.contractDetails === 'object' ? p.contractDetails : {}
  }
...
export async function migrateFromLocalStorage() {
  ...
  for (const p of legacy) {
    const prospect = {
      ...
      assigned: p.assigned || '',
      contractDetails: p.contractDetails && typeof p.contractDetails === 'object' ? p.contractDetails : {}
    }
